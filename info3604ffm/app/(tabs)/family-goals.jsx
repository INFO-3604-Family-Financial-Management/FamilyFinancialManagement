...
const FamilyGoals = () => {
  return (
    <SafeAreaView className='bg-gray-500 h-full'>
        ...
        {/* @Varun this is going to have to be dynamic similar to the homepage. On click it will redirect to an edit goal page to edit the goal so you will need to make the api request using the goal id using props. idk how the backend code is for this and i too lazy to check rn  */}
        <View className='p-4 rounded-lg mt-5 h-[55vh]'>
            <View className="flex-1 justify-center bg-white items-center rounded-lg p-4 my-4 w-full">
                <TouchableOpacity className="flex-row items-center justify-between w-full p-4 mb-4 rounded-lg"
                    onPress={() => router.push('edit-family-goal')}
                >
